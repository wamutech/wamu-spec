...
const BenefitList: BenefitItem[] = [
  {
    ...
    description: (
      <>
        Threshold signatures are computed off-chain, so access-structure/security policy updates are free. Additionally,
        transactions are the same size, and thus cost the same as those generated by traditional singe-party
        signers/wallets.
      </>
    ),
  },
