...
const BenefitList: BenefitItem[] = [
  {
    ...
    description: (
      <>
        Threshold signatures are computed completely off-chain, so access-structure/security policy updates are free.
        Additionally, individual transactions are the same size (because they include only one jointly computed
        signature), and thus cost the same as those generated by traditional singe-party signers/wallets.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Threshold signatures are similar to standard signatures generated by traditional signers/wallets. So they work
        everywhere traditional singe-party signatures work. No custom integrations and/or additional standards are
        required.
      </>
    ),
  },
