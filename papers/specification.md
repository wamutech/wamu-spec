...
4. Follow the key refresh protocol described in [section 5](#key-refresh) with $P_i$ included as participant if the identity challenge above is passed.
...
1. Follow the key refresh protocol described in [section 5](#key-refresh) without $P_i$.
...
#### 12.2.1. Overview of share recovery with a backup  {#share-recovery-backup-overview}
...
#### 12.2.4. Further security and usability considerations for share recovery with a backup {#share-recovery-backup-enhancements}
